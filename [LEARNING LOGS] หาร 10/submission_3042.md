...
```text
โจทย์ให้ฉันอ่านจำนวนเต็มหนึ่งตัว แล้วให้แสดงจำนวนเต็มบวก ตั้งแต่ NUM ถึง 0 ที่หารด้วย 10 ลงตัว

Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า ตั้งเป็นตัวแปร NUM

Output:
โปรแกรมควรพิมพ์ จำนวนเต็มบวกตั้งแต่ NUM ถึง 0 ที่หารด้วย 10 ลงตัว

Constraints:
input เป็นจำนวนเต็ม ฉันควรพิจารณาคั่นข้อมูลแต่ละตัวด้วยช่องว่าง
```
...
```text
1.สร้างตัวแปร NUM รับค่าเป็นจำนวนเต็มบวก 
2.สร้างลิสว่างเปล่าไว้รับค่าตั้งเป็น LIST
3.สร้างลูป for i in range ลูปไปจนกว่า i จะมีค่าเท่ากับ NUM
4.สร้างเงื่อนไข ถ้า i หารสิบแล้วเหลือเศษเท่ากับศูนย์ ให้เพิ่ม i เข้าไปในลิส
5.พิมพ์ LIST ออกมาโดยใช้ index [::-1] เพื่อให้พิมพ์จากหลังมาหน้า
```
...
```text
ใช้แผนเดิมแต่เพิ่ม * ตอนปริ้นลิสเพื่อลบวงเล็บและลูกน้ำออก
```
