...
```text
รับค่าสตริง 5 บรรทัด และพิมสี่เหลี่ยมที่พิมพ์ด้วย*คลอบค่าสตริงห้าค่า

Input:
รับค่าสตริง 5 บรรทัด

Output:
ข้อความจำนวน 7 บรรทัดโดยจะมี space ระหว่างข้อความและกรอบซ้ายและขวาด้านละ  1 ช่อง

Constraints:
กรอบซ้ายและกรอบขวาต้องห่างกันอย่างน้อย 2 space และไม่นับอินพุทที่มีช่องว่างต่อท้ายเช่น "HELLO    "
```
...
```text
1 สร้างลิส CHAR และ NUM กำหนดให้เป็นลิสว่าง CHAR ไว้เก็บคำ NUM ไว้เก็บจำนวนตัวอักษรของคำ 
และให้ P เป็น "* "
2 สร้างลูป in range(5) ให้ C เก็บค่าสตริง จากนั้นเก็บค่าสตริงไว้ในลิส CHAR โดยใช้.rstrip เพื่อไม่นับช่องว่างข้างหลังคำ และเก็บค่าจำนวนตัวอักษรของคำลงนลิส NUM โดยใช้ len และ .rstrip
3 ให้ MAX เก็บค่าจำนวนตัวอักษรที่มากที่สุดในลิส NUM และบวกสี่
4 ให้ TIME เก็บค่าจำนวนข้อมูลนลิส CHAR
5 พิม * เป็นจำนวน MAX
6 สร้างลูป n in range(TIME) ให้ P += ลิสชาตัวที่ n จากนั้น P += ((MAX - len(P)) - 1) * " " และ P += "*" จากนั้นพิม P ก่อนจบลูป ให้ P เป็น "* " เหมือนเดิม
7 พิม * เป็นจำนวน MAX
