...
```text
โจทย์ให้ฉันอ่านจำนวนจริงหนึ่งตัว คือ อุณหภูมิ พร้อม str สองตัวแทนประเภทอุณหภูมิ ตัวแรกคือประเภทที่ใส่ค่ามา ตัวที่สองคือประเภทที่อยากรู้ว่าเปลี่ยนแล้วเป็นเท่าไหร่ 

Input:
โปรแกรมรับจำนวนจริงหนึ่งค่า เก็บค่าเป็นตัวแปร NUM
โปรแกรมรับค่า str เป็นประเภทของอุณหภูมิเก็บค่าเป็นตัวแปร TEM1
โปรแกรมรับค่า str เป็นประเภทของอุณหภูมิเก็บค่าเป็นตัวแปร TEM2

Output:
โปรแกรมควรพิมพ์ จำนวนจริงทศนิยมสองต่ำแหน่งคือ อุณหภูมิหลังแปลงเป็นประเภทที่ต้องการ

Constraints:
input เป็นจำนวนจริง ฉันควรพิจารณาการเรียงลำดับจากหลังมาหน้าในสมการตอนหา C
```
...
```text
1.สร้างตัวแปรเก็บค่าอุณหภูมิเป็นจำนวนจริง คือ NUM และสร้างตัวแปรเก็บประเภทอุณหภูมิของNUM คือ TEM1 และสร้างตัวแปรเก็บประเภทอุณหภูมิที่ต้องการทราบ คือ TEM2
2.สร้างตัวแปร C แทนหน่วยเซลเซียส และ ANS แทนค่าจำนวนจริงของอุณหภูมิที่ต้องการทราบ กำหนด ค่าทั้งสองตัวไว้เป็นศูนย์
3.สร้างเงื่อนไขหา C ก่อนเพราะในสมการทุกตัวมี C อยู่ โดยต้องกลับด้านเครื่องหมายจากบวกเป็นลบ จากคูณเป็นหาร  สร้างทั้งหมด สี่เงื่อนไข หาก TEM1 เป็น C ให้ C = NUM
4.สร้างเงื่อนไขคำนวณหาค่า ANS โดยทำทั้งหมดสี่เงื่อนไขหาก TEM2 คือตัวในไหนรูปที่โจทย์ให้มาก็ใช้สูตรตามรูป หาก TEM2 เป็น C ก็ให้ ANS = C
5.ปริ้น ANS โดยใช้ f format ใช้คำสั่ง :.2f เพื่อให้ค่าที่พิมพ์ออกมามีทศนิยมแค่สองตำแหน่ง
```
...
```text
ทำตามแผนแรกแต่แก้ตรงเงื่อนไขหา C โดยต้องกลับด้านลำดับจากหลังมหน้า เช่น หา R =  (C + 273.15) * 9 / 5 เป็น  C = ((R * 5) / 9) - 273.15
```
...
```text
เช็คเงื่อนไขหา C ว่าเข้าเงื่อนไข TEM1 == "C" ไหม
```
...
```text
เช็คแบบเงื่อนไขหา ANS ว่าถ้า TEM2 == "C" จะเข้าเงื่อนไขที่ตั้งไว้ไหม
```
