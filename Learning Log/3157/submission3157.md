...
```text
โจทย์ให้ตัวเลขจำนวนเต็มและจากนั้นจะให้ใส่ +, - กี่ครั้งตามเลขที่เราใส่ไปจากนั้นจะพิมพ์ คะแนนรวมสุดท้าย
Input:
รับค่าจำนวนเต็มหนึ่งค่า จากนั้นรับค่าสตริงตามจำนวนเลขจำนวนเต็มที่ใส่ไป

Output:
เลขคะแนนสุดท้ายจากการบวกและลบเป็นจำนวนเต็ม
...
```text
1.อ่านค่าจำนวนเต็มตัวแรกเก็บค่าเป็น NUM
2.สร้างตัวแปล START กำหนดค่าเป็น 0 มาเก็บคะแนน
3.สร้างรูป for i ตามจำนวน NUM
4.ให้รับค่าสตริงในรูปเก็บเป็นตัวแปร WHATs
5.ถ้า WHATs == "+" START += 10
6.ถ้า  WHATs == "-" START -=5
7.เมื่อจบลูปให้พิม START
```
...
```text
ตอนทำติด pep8 ตรง i แต่ตอนนั้นไม่รู้ว่าแก้ยังไงเลยใช้ i +=1-1 แต่ตอนนี้รู้แล้วว่าใช้ _ ได้
```
