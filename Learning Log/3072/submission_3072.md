...
```text
โจทย์ให้ฉันอ่านค่า str แล้วแสดงสระ a e i o u ที่อยู่ในคำนั้นออกมาว่ามีกี่ตัว

Input:
โปรแกรมรับค่า str เป็นตัวแปร WORD

Output:
โปรแกรมควรพิมพ์ "สระ a e i o u  : จำนวนสระ" 

Constraints:
input เป็น str และควรพิจารณาหากสระตัวไหนไม่มีก็ไม่ต้องพิมพ์ออกมา และควรแปลง WORD เป็นตัวพิมพ์เล็ก
```
...
```text
1.สร้างตัวแปร WORD รับค่า str และใช้คำสั่ง .lower() เพื่อแปลงเป็นตัวพิมพ์เล็ก
2.สร้างตัวแปร COUNT_สระ เพื่อเก็บจำนวนสระตัวนั้นว่ามีกี่ตัวใน WORD
3.สร้างเงื่อนไขแยกกันห้าเงื่อนไข ถ้า COUNT_สระ ตัวนั้นไม่ใช่ศูนย์ ให้พิมพ์ สระตัวนั้น : จำนวนสระตัวนั้น
```
...
```text
เช็คเวลามีอย่างอื่นนอกจากตัวอักษร
```
