...
```text
รับค่าสี่ค่าบรรทัดละสอง จากนั้นแสดงผลรางวัลเงินที่ได้

Input:
บรรทัดแรกมีสองตัว คือ C1, N1
บรรทัดสองมีสองตัว คือ C2, N2

Output:
จำนวนเงินรางวัลที่ได้
...
```text
1 บรรทัดแรกสร้างตัวแปรสองตัวคือ C1 คือตัวอักษรของสลากรางวัล N1 คือเลขสลากรางวัล ใช้ split แยกตัวแปร
2 บบรทัดสองสร้างตัวแปรสองตัวคือ C2 คือตัวอักษรของสลากที่ซื้อ N2 คือเลขสลากที่ซื้อ ใช้ split แยกตัวแปร
3 สร้างเงื่อนไขถ้า C1 == C2 and N1 == N2 พิมพ์ 1000000
4 ถ้า N1 == N2 พิมพ์ 100000
5 ถ้า C1 == C2 and N1[2::1] == N2[2::1] เลขท้ายสามตัวและอักษรตรง พิมพ์ 2000
6 ถ้า C1 == C2 and N1[3::1] == N2[3::1] เลขท้ายสองตัวและตัวอักษรตรง พิมพ์ 1000
7 ถ้า N1[2::1] == N2[2::1] เลขท้ายสามตัวตรงอย่างเดียว พิมพ์  200
8 ถ้า N1[3::1] == N2[3::1] เลขท้ายสองตัวตรงอย่างเดียว พิมพ์ 100
9 ถ้า C1 == C2 ตัวอักษรตรงอย่างเดียว พิมพ์ 20
10 หากไม่ตรงกับเงื่อนไขไหนเลข พิมพ์ 0
```
...
```text
ทำตามแผนแรกแต่ตอนส่งครั้งแรกเรียงเงื่อนไขผิดคือเรียงตามโจทย์เลย
```
