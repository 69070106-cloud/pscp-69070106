...
```text
อ่านค่าจำนวนนับ สี่ตัว และพิมพ์จำนวนเลขที่อยู่ในช่องตัวแปรที่หนึ่งกับสอง ว่าหารตัวแปรตัวที่สามเหลือเศษเป็นตัวแปรตัวที่สี่ มีกี่จำนวน

Input:
รับจำนวนนับ สี่ตัว สี่บรรทัด

Output:
พิมพ์จำนวนตัวเลขในช่วง A,B หาร C เหลือเศษ  R ว่ามีกี่ตัว
...
```text
1. รับค่าจำนวนนับ สี่ตัว สี่บรรทัด สองตัวแรกคือช่วงตัวเลข เริ่มที่ตัวแรก ให้เป็น A ตัวที่สอง เป็น B ตัวที่สามคือตัวที่เอามาหาร คือ C และตัวที่สี่คือเศษที่เหลือจากการหาร คือ R
2. สร้างตัวแปร ANS เป็น ศูนย์ ใช้สำหรับเก็บจำนวนครังที่ตรงเงื่อนไข
3. สร้างรูป for i in range เริ่มที่A และจบที่ B+1 
4. สร้างเงื่อนไข ถ้า i หาร C แล้วเหลือเศษ R หากเป็นจริงให้ บวกหนึ่งเข้าไปใน ตัวแปร ANS
ปริ้น ANS
```
...
```text
เช็คแบบช่วงตัวเลขมีแค่ตัวเดียว
```
