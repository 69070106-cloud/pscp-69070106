...
```text
รับค่าจำนวนเต็มสามตัวนบรรทัดแรก และอีกสามตัวนบรรทัดที่สอง จากนั้นพิมค่าเฉลี่ยของแต่ละช่อง

Input:
บรรทัดแรกรับค่าจำนวนเต็ม 3 ตัว โดยคั่นด้วยช่องว่าง
บรรทัดสองรับค่าจำนวนเต็ม 3 ตัว โดยคั่นด้วยช่องว่าง

Output:
ค่าเฉลี่ยของแต่ละช่อง
...
```text
1 สร้างตัวแปล R1, G1, B1 เก็บค่าเป็นจำนวนเต็ม โดยใช้mapเพื่อให้ทั้งสามตัวเก็บค่าเป็นintได้ และใช้ .split() เพื่อแยกตัวแปรด้วยช่องว่าง
2 สร้างตัวแปล R2, G2, B2 ทำแบบข้อแรก
3 หาค่าเฉลี่ยของแต่ละตัว R, G, B โดยเอาตัวแปรที่อักษรเดียวกันมาบอกแล้วหารไม่เอาเศษด้วยสอง ตัวอย่าง (R1 + R2) // 2 ทำทั้งสามตัวจากนั้นเก็บค่าไว้ใน R_A, G_A, B_A
4 พิม R_A, G_A, B_A
```
...
```text
เช็คช่องตรงกลางเป็น 0 ทั้งสองตัว 
```
...
```text
เช็คช่องแรกเป็น 0 ทั้งสองตัว และการหารมีเศษ
```
